...
import { LayoutDashboard, Server, Users, Settings, Database, FileCode, Zap, Palette, Menu, X, DollarSign, MessageCircle } from "lucide-react";
...
const sidebarItems = [
    ...
    { icon: MessageCircle, label: "Asistente AI", href: "/assistant" },
            ...
            <div className="p-3 border-t border-gray-100">
                <div className="flex items-center gap-3 px-3 py-2">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 truncate">admin@renace.tech</p>
                    </div>
                </div>
            </div>
        </>
