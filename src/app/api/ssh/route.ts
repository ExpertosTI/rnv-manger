...
export async function POST(request: NextRequest) {
    try {
        ...
        await logAudit({ action: "SSH_COMMAND", entity: "system", description: "Comando SSH ejecutado en " + (body.host || "unknown"), metadata: { command: body.command }, ipAddress: getClientIP(request) });
